...
if (!_tb_dis) {
    ...
    var _pmpmk = pm_ppy + '/pmk-201827008.1.js';
    var _pmasync = true;
    ...
    'sx': '//ol[contains(@class,"breadcrumbs")]//li[3]/a',
    'at': '(//meta[@property="article:author"]/@content | //span[contains(@itemprop, "author")]//a[contains(@class, "author")])[1]'
};

var _tb_vautop = false;

var _tb_vpx = [{
        'xpath': '//div[contains(@class,"pfpPlayer__wrapper")]/iframe',
        'attr': 'iframe'
    },
    {
        'xpath': '//div[contains(@class,"intrinsic-container")]//iframe',
        'attr': 'iframe'
    }
];
...
_tb_ext_xp = {
    ...
    'facebook': [{
        'xpath': '//div[contains(@class,"c-site-header__logo")]//a/img',
        'attr': 'div'
    }]
